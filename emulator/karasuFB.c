...
void KarasuInit() {
    ...
    outputTexture = malloc(1*1024*1024);
    memset((void*)framebuffer,0,1*1024*1024);
    memset((void*)outputTexture,0,1*1024*1024);
...
void KarasuUploadFrame() {
    ...
    if(FBMode == 0) {
        ...
        for(int i=0; i < (1024*768); i++) {
            outputTexture[i] = KarasuPalette[framebuffer[i]];
        }
    }
    SDL_Rect rect = {
		.x = 0,
    ...
    if(SDL_UpdateTexture(FBTexture, &rect, outputTexture, 1024 * 4) != 0) {
